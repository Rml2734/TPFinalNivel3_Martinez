...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Filtro de búsqueda rápida con AutoPostBack para una respuesta ágil -->
    <div class="row mb-4">
        <div class="col-6">
    ...
    <div class="container text-center">
        <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            <!-- Repeater: Control de datos para renderizar la galería de productos de forma dinámica -->
            <asp:Repeater ID="repRepetidor" runat="server">
                <ItemTemplate>
                    <div class="col">
                        <!-- Card con estilos personalizados y transiciones CSS para mejorar la UX -->
                        <div class="card h-100 shadow-sm border-0 transition-all card-custom" style="transition: transform .2s; border-radius: 15px; overflow: hidden;">
                            <div class="position-relative bg-light">
                                <!-- Manejo de imagen con evento onerror para cargar un placeholder si falla el link -->
                            ...
                            <div class="card-body">
                                ...
                                <!-- Formateo de moneda con separador de miles y decimales -->
                                <h4 class="text-success fw-bold">₡<%# string.Format("{0:N2}", Eval("Precio")) %>
                                </h4>
                            </div>
                            ...
                            <div class="card-footer bg-white border-0 pb-3">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                                    ...
                                    <!-- Botón de favoritos vinculado a la lógica de negocio -->
